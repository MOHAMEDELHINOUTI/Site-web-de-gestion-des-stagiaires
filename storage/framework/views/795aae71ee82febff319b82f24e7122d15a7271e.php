            ...
            <div class="card my-5">
                <div class="card-header">
                    <div class="text-center font-weight-bold text-uppercase">
                        <h4><?php echo e($stagiaire->full_name); ?></h4>
                    </div>
                    <hr>
                    <div class="mt-2 text-center font-weight-bold text-uppercase">
                        <a href="<?php echo e(route('work.certificate',$stagiaire->registration_number)); ?>" class="btn btn-outline-danger">
                        ...
                        value="<?php echo e($stagiaire->registration_number); ?>">
                        </div>
                        ...
                        <div class="form-group mb-3" > <label for="fullname">Nom Complet</label>
                            ...
                            value="<?php echo e($stagiaire->full_name); ?>">
                            </div>
                        ...
                        <div class="form-group mb-3" > <label for="fullname">Spécialité</label>
                                ...
                                value="<?php echo e($stagiaire->depart); ?>">
                                </div>
                        ...
                        value="<?php echo e($stagiaire->hire_date); ?>">
                        </div>
                        ...
                        value="<?php echo e($stagiaire->phone); ?>">
                         </div>
                         ...
                         <div class="form-group mb-3" > <label for="adress">Adress</label>
                            ...
                            value="<?php echo e($stagiaire->adress); ?>">
                             </div>
                        ...
                        <div class="form-group mb-3" > <label for="adress">City</label>
                                ...
                                value="<?php echo e($stagiaire->city); ?>">
                         </div>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Documents\laravel9\stagiaire\resources\views/stagiaires/show.blade.php ENDPATH**/ ?>