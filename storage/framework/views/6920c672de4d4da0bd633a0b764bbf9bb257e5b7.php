    ...
    <div class="row ">
        <div class="col-md-8 mx-auto">
            <div class="card my-5">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('stagiaires.store')); ?>" class="mt-3" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Documents\laravel9\stagiaire\resources\views/stagiaires/create.blade.php ENDPATH**/ ?>